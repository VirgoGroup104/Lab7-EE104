...
ee104TrainImagePath = f'{workspace_base_dir}\\datasets\\coco128\\images\\ee104_train'
ee104TrainLabelPath = f'{workspace_base_dir}\\datasets\\coco128\\labels\\ee104_train'
ee104ValImagePath = f'{workspace_base_dir}\\datasets\\coco128\\images\\ee104_val'
ee104ValLabelPath = f'{workspace_base_dir}\\datasets\\coco128\\labels\\ee104_val'
coco_images = f'{workspace_base_dir}\\datasets\\coco128\\images\\train2017' #dir where downloaded images are stored
coco_labels = f'{workspace_base_dir}\\datasets\\coco128\\images\\train2017' #dir where downloaded annotations txt files are stored
